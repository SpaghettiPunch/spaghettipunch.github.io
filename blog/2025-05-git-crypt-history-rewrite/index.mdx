...
Despite abundant vocal purist git proponents of "never rewriting published git history", there are [some good reasons](https://drewdeponte.com/blog/when-to-rewrite-git-history/) to do so. Moreover, this conundrum has [quite](https://github.com/AGWA/git-crypt/issues/7) a [bit](https://github.com/AGWA/git-crypt/issues/132) of [demand](https://github.com/AGWA/git-crypt/issues/137) for a good approach.
...
:::warning
This process will affect every commit in your repository, change ref hashes, and otherwise shares all the dangers of any delving into rewriting git history.
